...
List<List<UserItem>> demoUserItems = [
  [
    UserItem.demo(
      ...
      5021536,
      DateTime.utc(2021, 7, 26).millisecondsSinceEpoch,
    ),
    UserItem.demo(
        ...
        5009489,
        DateTime.utc(2021, 7, 29).millisecondsSinceEpoch),
    UserItem.demo(
        ...
        5053903,
        DateTime.utc(2021, 8, 3).millisecondsSinceEpoch),
    UserItem.demo(
  ...
  [
    ...
    UserItem.demo(
        ...
        'https://coldstorage-s3.dexecure.net/product/5055950_01_5055950.jpg',
        5055950,
        DateTime.utc(2021, 8, 7).millisecondsSinceEpoch),
  ]
];
